...
pygame.mixer.init()
pygame.mixer.music.load("Sources/Music/1.wav")
pygame.mixer.music.play(-1)

wallTextures = {
    '1': pygame.image.load('Sources/Level 1/a.jpg'),
    '2': pygame.image.load('Sources/Level 1/b.jpg'),
    '3': pygame.image.load('Sources/Level 1/c.jpg'),
    '4': pygame.image.load('Sources/Level 1/b.jpg'),
    '5': pygame.image.load('Sources/Level 1/floor.jpg')
    }

enemies = [{"x" : 100,
            "y" : 200,
            "sprite" : pygame.image.load('Sources/Level 1/1.png')},

           {"x" : 350,
            "y" : 150,
            "sprite" : pygame.image.load('Sources/Level 1/2.png')},

            {"x" : 300,
             "y" : 400,
             "sprite" : pygame.image.load('Sources/Level 1/3.png')}
    ]
...
class Game(object):
    def __init__(self, screen, clock, width, height):
        ...
        self.rCaster.load_map("map 1.txt")
    ...
    def start(self):
        ...
        while isRunning:
            ...
            if not self.rCaster.compareChanges():
                #Techo
                self.screen.fill(pygame.Color("cadetblue3"), (0, 0,  width, int(height / 2)))
                #Piso
                self.screen.fill(pygame.Color("gray31"), (0, int(height / 2),  width, int(height / 2)))
                self.rCaster.render()
