...
wallTextures = {
    '1': pygame.image.load('Sources/Level 3/a.jpg'),
    '2': pygame.image.load('Sources/Level 3/b.jpg'),
    '3': pygame.image.load('Sources/Level 3/c.jpg'),

}

enemies = [{"x" : 100,
            "y" : 200,
            "sprite" : pygame.image.load('Sources/Level 3/1.png')},

           {"x" : 350,
            "y" : 150,
            "sprite" : pygame.image.load('Sources/Level 3/2.png')},

            {"x" : 300,
             "y" : 400,
             "sprite" : pygame.image.load('Sources/Level 3/3.png')}
    ]
...
class Game3(object):
    def __init__(self, screen, clock, width, height):
        ...
        self.rCaster.load_map("map 3.txt")
    ...
    def start(self):
        ...
        while isRunning:
            ...
            if not self.rCaster.compareChanges():
                #Techo
                self.screen.fill(pygame.Color("grey3"), (0, 0,  width, int(height / 2)))
                #Piso
                self.screen.fill(pygame.Color("steelblue"), (0, int(height / 2),  width, int(height / 2)))
                self.rCaster.render()
